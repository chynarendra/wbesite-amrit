                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    {!! Form::text('name',null,['class'=>'form-control','placeholder'=>'Product Category  Name','autocomplete'=>'off']) !!}
                                                                    {!! $errors->first('name', '<small class="text text-danger">:message</small>') !!}
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="inputName">{{trans('app.short_name')}}</label>
                                                                    {!! Form::text('short_name',null,['class'=>'form-control','placeholder'=>'Product Category Short  Name','autocomplete'=>'off']) !!}
