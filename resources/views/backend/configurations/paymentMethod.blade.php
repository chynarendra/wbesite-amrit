                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="inputName">{{trans('app.name')}}</label> <label class="text-danger">*</label>
                                                                    {!! Form::text('method_name',null,['class'=>'form-control','placeholder'=>'Payment Method  Name','autocomplete'=>'off']) !!}
                                                                    {!! $errors->first('method_name', '<small class="text text-danger">:message</small>') !!}
                                                                </div>
                                                                <div class="form-group">
