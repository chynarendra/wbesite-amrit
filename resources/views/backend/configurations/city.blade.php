                                ...
                                <table id="example2" class="table table-striped table-bordered table-hover">
                                    ...
                                    @foreach($results as $key=>$data)
                                        <tr>
                                            ...
                                            <td>
                                                @if($data->district->name_en)
                                                {{$data->district->name_en}}
                                                @endif
                                            </td>
                                            <td>
                                                @if($data->status == '1')
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group  {{ ($errors->has('district_id'))?'has-error':'' }}">
                                                                    <label>{{trans('District')}}</label> <label
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    {!! Form::text('city_name',null,['class'=>'form-control','placeholder'=>'City Name','autocomplete'=>'off']) !!}
                                                                    {!! $errors->first('city_name', '<small class="text text-danger">:message</small>') !!}
                                                                </div>
                                                                <div class="form-group">
