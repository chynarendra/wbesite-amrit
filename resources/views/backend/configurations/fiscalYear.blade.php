                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="row">
                                                                    <div class="form-group col-md-12">
                                                                        <label for="inputName">{{trans('app.code')}}</label> <label class="text-danger">*</label>
                                                                        <label class="text-danger">*</label>
                                                                        {!! Form::text('code',null,['class'=>'form-control','placeholder'=>'Fiscal Year Code','autocomplete'=>'off']) !!}
                                                                        {!! $errors->first('code', '<small class="text text-danger">:message</small>') !!}
                                                                    </div>
                                                                    <div class="form-group col-md-6">
                                                                        <label for="inputName">{{trans('app.start_date')}}</label> <label class="text-danger">*</label>
                                                                        {!! Form::text('start_date',null,['class'=>'form-control startDate','placeholder'=>'Start Date','autocomplete'=>'off']) !!}
                                                                        {!! $errors->first('start_date', '<small class="text text-danger">:message</small>') !!}
                                                                    </div>
                                                                    <div class="form-group col-md-6">
                                                                        <label for="inputName">{{trans('app.end_date')}}</label> <label class="text-danger">*</label>
                                                                        {!! Form::text('end_date',null,['class'=>'form-control endDate','placeholder'=>'End Date','autocomplete'=>'off']) !!}
                                                                        {!! $errors->first('end_date', '<small class="text text-danger">:message</small>') !!}
                                                                    </div>
