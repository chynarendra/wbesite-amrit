                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" style="text-align:right">
                                ...
                                @if(  $request->from_date != null ||  $request->to_date != null ||  $request->mobile != null ||  $request->status != null )
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div id="accordion">
                                        ...
                                        <div id="search"
                                             class="panel-collapse collapse @if($request->from_date != null ||  $request->to_date != null ||  $request->status != null ||  $request->mobile != null)show @endif">
                                            <table class="table table-responsive p-0" width="100%">
                                                <form
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {!!Form::text('from_date',Request::get('from_date'),['class'=>'form-control','id'=>'start_eng_date','autocomplete'=>'off','width'=>'100%','placeholder'=>
                                                                               trans('From Date'),'readonly']) !!}
                                                        </td>

                                                        <td>
                                                            {!!Form::text('to_date',Request::get('to_date'),['class'=>'form-control','id'=>'end_eng_date','autocomplete'=>'off','width'=>'100%','placeholder'
                                                                                =>
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-striped table-bordered table-hover">
                                        ...
                                        @foreach($results as $key=>$data)
                                            ...
                                            @include('backend.modal.product_add_modal')
                                        @endforeach
                                        </tbody>
                                    </table>
