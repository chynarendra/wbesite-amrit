                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 {{ ($errors->has('followup_date'))?'has-error':'' }}">
                                    ...
                                    {{Form::select('status',customerStatus(),Request::get('status'),['class'=>'form-control select2 status_id','placeholder'=>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 {{ ($errors->has('followup_date'))?'has-error':'' }}"
                                    ...
                                    {{ Form::text('followup_date',null,['placeholder'=>' Followup Date','id'=>'follow_date','autocomplete'=>'off','class' => 'form-control followup-date','readonly']) }}
