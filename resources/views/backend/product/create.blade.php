                ...
                <div class="col-md-12" id="listing">
                    <div class="card card-default">
                        <div class="card-header with-border">
                            ...
                            $permission = helperPermissionLink(url('product/' . 'create'), url('/product'));
                        ...
                        <div class="card-body">
                            {!! Form::open(['method'=>'post','url'=>'product','enctype'=>'multipart/form-data','file'=>true]) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 text-center">
                                    ...
                                    &nbsp;
                                    <a  class="btn btn-danger" href="{{url('product')}}">{{trans('app.cancel')}}</a>
                                </div>
