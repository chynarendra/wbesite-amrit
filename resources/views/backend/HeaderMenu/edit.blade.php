                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ ($errors->has('menu_type'))?'has-error':'' }}">
                            ...
                            {{Form::select('menu_type',$menuTypes,Request::get('menu_type'),['class'=>'form-control select2','id'=>'menuTypeEdit','style'=>'width: 100%;','placeholder'=>
                                                'Select Menu Type','required'=>'required'])}}
                            {!! $errors->first('menu_type', '<span class="text text-danger">:message</span>') !!}
                        </div>
                    </div>

                    <div class="col-md-6" id="moduleEdit" style="display: none;">
                    ...
                    <div class="col-md-6" id='pageEdit' style="display: none;">
                    ...
                    <div class="col-md-6" id="externalUrlEdit" style="display: none;">
